...
<?php
	if ( isset( $_SESSION['admin'] ) && ( $_SESSION['admin'] ))
	{
		...
		<div class="admin_actions">
			<img class="tango" src="display/images/tango/32x32/actions/system-log-out.png" border="0" alt="logout" />
			<a href="?id=logout">logout</a>
			<img class="tango" src="display/images/tango/32x32/mimetypes/application-certificate.png" border="0" alt="agreement" />
			<a href="?id=admin&amp;doctype=agreement">new agreement</a>
			<img class="tango" src="display/images/tango/32x32/mimetypes/text-x-generic.png" border="0" alt="minutes" />
